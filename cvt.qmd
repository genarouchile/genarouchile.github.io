...
<div class="cvt-violin-figure">

![Distribution of normalized territorial indicators in the 52 communes of the Metropolitan Region.](images/cvt-indicadores-normalizados.png)
...
The robustness of the IPT-CVT was assessed by examining how changes in
the weighting of the main dimensions affect the resulting territorial
prioritization.

The analysis compares the alternative scenarios using rank correlation,
the coincidence among the 10% highest-priority communes, the Jaccard
index for the top 10%, and the average change in commune rankings.

The results provide an assessment of the stability of the territorial
prioritization under alternative weighting specifications.

<div class="cvt-sensitivity-figure">

![Sensitivity analysis of the IPT-CVT under alternative weighting scenarios.](images/cvt-sensitivity-analysis.png)
...
The IPT-CVT can be examined from different analytical perspectives.
Select an option below to explore the results.

<div class="cvt-explorer">

<div class="cvt-explorer-options">

<label>
<input type="radio" name="cvt-analysis" value="distribution" checked>
Distribution
</label>

<label>
<input type="radio" name="cvt-analysis" value="sensitivity">
Sensitivity analysis
</label>
...
<div id="cvt-distribution" class="cvt-analysis-panel">

<h4>Distribution of normalized indicators</h4>

<img src="images/cvt-indicadores-normalizados.png"
     alt="Distribution of normalized indicators">

</div>


<div id="cvt-sensitivity" class="cvt-analysis-panel" style="display:none;">

<h4>Sensitivity analysis</h4>

<img src="images/cvt-sensitivity-analysis.png"
     alt="Sensitivity analysis of the IPT-CVT">
...
document.querySelectorAll(
  'input[name="cvt-analysis"]'
).forEach(function(radio) {

  radio.addEventListener("change", function() {

    document.getElementById("cvt-distribution").style.display =
      this.value === "distribution" ? "block" : "none";

    document.getElementById("cvt-sensitivity").style.display =
      this.value === "sensitivity" ? "block" : "none";
